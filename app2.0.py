...
model = "crck_model2.py"  # Replace with your actual model
# with open("crck_model2.pkl", 'wb') as file:
#     pickle.dump(crcp, file)
...
# Load the model from the saved file
   with open("crck_model2.pkl", 'rb') as file:
...
with col2:
    bowling_team=st.selectbox('select the bollowing team',teams)
...
predict = model.predict(prediction_array,prediction_array)
